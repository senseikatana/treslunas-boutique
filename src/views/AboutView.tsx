      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        >
          <div>
            ...
            <h1 className="font-heading font-black text-3xl sm:text-4xl md:text-5xl uppercase tracking-tight mt-1">
              SOBRE NOSOTROS
            </h1>
            <p className="text-base md:text-lg font-serif italic text-zinc-400 mt-1">
          ...
          <div className="space-y-3 pt-2">
            <h3 className="font-serif font-bold text-lg text-[#EAB393]">The Philosophy</h3>
            <div className="grid grid-cols-3 gap-4 pt-2">
              
              <div className="text-center space-y-2 p-3 rounded-lg border border-zinc-800 bg-zinc-900/30">
                <Moon className="w-6 h-6 mx-auto text-[#c37b58]" />
                <span className="font-heading font-bold text-xs uppercase tracking-wider block">SOSTENIBLE</span>
              </div>

              <div className="text-center space-y-2 p-3 rounded-lg border border-zinc-800 bg-zinc-900/30">
                <Sparkles className="w-6 h-6 mx-auto text-[#c37b58]" />
                <span className="font-heading font-bold text-xs uppercase tracking-wider block">ARTESANAL</span>
              </div>

              <div className="text-center space-y-2 p-3 rounded-lg border border-zinc-800 bg-zinc-900/30">
                <div className="flex justify-center">
                  <TripleMoonLogo variant="copper" showText={false} />
                </div>
                <span className="font-heading font-bold text-xs uppercase tracking-wider block">ATEMPORAL</span>
              </div>
          ...
          <div className="pt-6 border-t border-zinc-800/40 space-y-2 text-center md:text-left">
            <h4 className="font-serif font-bold text-base text-[#EAB393]">VISIT US</h4>
            <div className="text-xs text-zinc-400 space-y-1">
              <p>Encuéntranos en Cambrils:</p>
              <p className="font-semibold text-zinc-200">Carrer de les Tres Llunes, 12, 43850 Cambrils, Spain.</p>
              <p className="italic text-zinc-500">Abierto de Lunes a Sábado.</p>
            </div>
